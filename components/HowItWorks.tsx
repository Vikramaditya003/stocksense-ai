...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-28 relative bg-[#060C0D]">
      <div className="max-w-[960px] mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-[52px] font-light text-white tracking-[-0.03em] leading-tight mb-4">
            Forecasts in{" "}
            <span className="text-slate-500">under 60 seconds</span>
          </h2>
          ...
          {steps.map((step, i) => (
            ...
            >
              <div className="flex items-start justify-between mb-5">
                <div className="w-9 h-9 rounded-xl bg-[#2DD4BF]/[0.08] border border-[#2DD4BF]/15 flex items-center justify-center text-[#2DD4BF] group-hover:bg-[#2DD4BF]/[0.12] transition-colors">
                  {step.icon}
                </div>
                <span className="text-4xl font-light text-white/[0.05] leading-none tabular-nums">{step.step}</span>
              </div>
              <h3 className="text-[16px] font-semibold text-slate-100 mb-2 tracking-tight">{step.title}</h3>
        ...
        >
          <div>
            <p className="text-[16px] font-semibold text-slate-100 tracking-tight mb-0.5">
