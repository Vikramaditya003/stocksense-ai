    ...
    <section id="pricing" className="py-28 bg-white relative overflow-hidden">
      <div className="max-w-[860px] mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10">
          ...
          {/* Pro */}
          <FadeIn delay={2}>
          <div className="rounded-[10px] border-2 border-[#006d34]/35 bg-white p-7 flex flex-col relative overflow-hidden card-pro-glow h-full">
            <div className="mb-6">
              <div className="flex items-center justify-between mb-1">
                <p className="text-[13px] font-semibold text-[#181d1b]">Pro</p>
                <span className="text-[10px] font-bold text-[#006d34] uppercase tracking-widest border border-[#006d34]/25 bg-[#006d34]/[0.07] px-1.5 py-0.5 rounded-[4px]">
                  Most popular
                </span>
              </div>
              <p className="text-[13px] text-[#5a6059] mb-5">For stores that can&apos;t afford stockouts.</p>
              <div className="flex items-end gap-1.5 mb-1">
                <span className="text-[64px] font-black text-[#181d1b] tracking-[-0.04em] leading-none">{proPrice}</span>
                <span className="text-[14px] text-[#8a9a8a] mb-2">/{proBilling.replace("per ", "")}</span>
              </div>
