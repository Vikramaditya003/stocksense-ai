...
const rows: { feature: string; us: React.ReactNode; them: React.ReactNode; note?: string }[] = [
  ...
  { feature: "Starting price", us: <span className="font-bold text-[#006d34]">$10/mo</span>, them: <span className="font-bold text-slate-300">$49/mo</span> },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            ...
            },
            {
              ...
              body: "Prediko's paid plans start at $49/month. Forestock Pro is $10/month — the same AI-powered stockout predictions for a fraction of the cost.",
            },
            {
