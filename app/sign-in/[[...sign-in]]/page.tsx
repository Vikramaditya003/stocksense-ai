        ...
        <SignIn
          appearance={{
            ...
            elements: {
              ...
              headerSubtitle: "!text-emerald-100/50",
              ...
              formFieldLabel: "!text-emerald-100/70 !text-sm !font-medium",
              formFieldInput: "!bg-emerald-900/60 !border !border-emerald-700/30 focus:!border-emerald-500/50 focus:!ring-0 !text-white !rounded-xl !placeholder-emerald-400/30",
