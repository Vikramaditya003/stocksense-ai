...
export default function SignInPage() {
  return (
    <div className="min-h-screen bg-[#060C0D] flex flex-col items-center justify-center px-4 relative overflow-hidden">
      {/* Teal glow */}
      <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-[#2DD4BF]/[0.06] blur-[140px] rounded-full pointer-events-none" />
        ...
        <SignIn
          appearance={{
            ...
            elements: {
              ...
              card: "!bg-[#0A1415] !shadow-2xl !shadow-black/70 !border !border-[#2DD4BF]/15 !rounded-2xl",
              headerTitle: "!text-white !font-semibold !tracking-tight",
              headerSubtitle: "!text-slate-500",
              socialButtonsBlockButton: "!bg-[#0F1C1E] !border !border-[#2DD4BF]/15 hover:!border-[#2DD4BF]/30 !text-slate-300 !rounded-xl",
              socialButtonsBlockButtonText: "!text-slate-300",
              dividerLine: "!bg-[#2DD4BF]/10",
              dividerText: "!text-slate-600",
              formFieldLabel: "!text-slate-400 !text-sm",
              formFieldInput: "!bg-[#0F1C1E] !border !border-[#2DD4BF]/15 focus:!border-[#2DD4BF]/40 !text-white !rounded-xl",
              formButtonPrimary: "!bg-[#2DD4BF] hover:!bg-[#14B8A6] !text-[#060C0D] !font-bold !shadow-lg !shadow-[#2DD4BF]/20 !rounded-xl",
              footerActionLink: "!text-[#2DD4BF] hover:!text-white",
