...
export const metadata: Metadata = {
  title: "Terms of Service — Forestock",
  description: "Terms and conditions for using Forestock inventory forecasting service.",
};
      ...
      <div className="max-w-[720px] mx-auto px-6 pt-28 pb-16">
        ...
        <div className="space-y-10 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>By accessing or using Forestock (&quot;Service&quot;) at getforestock.com, you agree to be bound by these Terms of Service. If you do not agree, do not use the Service.</p>
          ...
          <section>
            ...
            <p>Forestock is an AI-powered inventory forecasting tool that helps Shopify merchants predict stockouts, analyse sales trends, and optimise reorder decisions. The Service is provided on a subscription basis.</p>
          ...
          <section>
            ...
            <p>You must be at least 18 years old and capable of entering into a binding contract to use this Service. By using Forestock, you represent that you meet these requirements.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-white mb-3">4. User Accounts</h2>
            <p>You are responsible for maintaining the confidentiality of your account credentials and for all activity that occurs under your account. Notify us immediately at support@getforestock.com if you suspect unauthorised access.</p>
          ...
          <section>
            ...
            <p>Forestock, including its software, design, AI models, and content, is owned by us and protected by applicable intellectual property laws. You retain ownership of any data you upload.</p>
          ...
          <section>
            ...
            <div className="bg-[#22C55E]/[0.05] border border-[#22C55E]/20 rounded-xl p-4">
              <p className="text-slate-300">Forecasts generated by Forestock are <strong className="text-white">estimates based on historical data</strong> and AI analysis. They are not guaranteed predictions of future inventory needs or sales performance.</p>
          ...
          <section>
            ...
            <p>To the maximum extent permitted by applicable law, Forestock shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or goodwill, arising from your use of the Service.</p>
