      ...
      <div className="max-w-[960px] mx-auto px-6 py-16">
        ...
        <div className="mb-8">
          <Link
            ...
            className="group block bg-white/[0.02] hover:bg-white/[0.04] border border-white/[0.06] hover:border-[#22C55E]/20 rounded-2xl p-8 transition-all"
          >
            ...
            <h2 className="text-xl font-bold text-white mb-3 group-hover:text-[#22C55E] transition-colors leading-snug">
              {featured.title}
            </h2>
            ...
            <div className="flex items-center gap-4 text-xs text-[#475569]">
              ...
              <span className="ml-auto text-[#22C55E] group-hover:translate-x-0.5 transition-transform">Read →</span>
            </div>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {rest.map((post) => (
            <Link
              key={post.slug}
              href={`/blog/${post.slug}`}
              className="group block bg-white/[0.02] hover:bg-white/[0.04] border border-white/[0.06] hover:border-[#22C55E]/20 rounded-xl p-6 transition-all"
            >
              <div className="mb-3">
              ...
              <h3 className="text-[15px] font-semibold text-white mb-2 group-hover:text-[#22C55E] transition-colors leading-snug">
                {post.title}
              </h3>
        ...
        {/* CTA */}
        <div className="mt-16 border border-[#22C55E]/15 rounded-2xl p-8 text-center bg-[#22C55E]/[0.02]">
